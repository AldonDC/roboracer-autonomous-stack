...
class QCarNode(Node):
	...
	def IMU_callback(self):
		...
		# Valores típicos para el IMU del QCar (ajustable según la calibración)
		stateIMU.angular_velocity_covariance = [
			0.01, 0.0,  0.0,   # varianza en x
			0.0,  0.01, 0.0,   # varianza en y
			0.0,  0.0,  0.01   # varianza en z
		]
		
		# Covarianza para aceleración lineal (m/s^2)^2
		stateIMU.linear_acceleration_covariance = [
			0.02, 0.0,  0.0,   # varianza en x
			0.0,  0.02, 0.0,   # varianza en y
			0.0,  0.0,  0.02   # varianza en z
		]
		
		# No hay orientación absoluta, valor dejado en -1
