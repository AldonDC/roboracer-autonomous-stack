...
def generate_launch_description():
    ...
    return LaunchDescription([
        DeclareLaunchArgument('nodes', default_value='qcar,csi,rgbd,lidar_qos', description='List of nodes to launch: command, qcar, csi, rgbd, lidar_qos, imu_external. Separate with commas and select as needed.'),
        DeclareLaunchArgument('csi_cameras', default_value='csi_right,csi_left,csi_front,csi_back', description='List of CSI cameras: csi_front, csi_left, csi_right, csi_back. All cameras publish CompressedImage topics. In green QCar the right camera has lag. Separate with commas and select as needed.'),
